...
var ChatBotModule = /** @class */ (function () {
    ...
    ChatBotModule = __decorate([
        core_1.NgModule({
            declarations: [chat_bot_component_1.ChatBotComponent, speech_component_1.SpeechComponent, conversation_component_1.ConversationComponent, visual_output_component_1.VisualOutputComponent, chat_window_component_1.ChatWindowComponent, home_page_component_1.HomePageComponent],
            imports: [
